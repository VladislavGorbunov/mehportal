...
class PagesController extends Controller
{
    ...
    public function addOrderPage()
    {
        ...
        $data['description'] = 'Ищите исполнителя для выполнения заказа? Разместите заказ на металлообработку на портале «МЕХПОРТАЛ» и получайте выгодные коммерческие предложения от проверенных исполнителей и выбирайте лучшее предложение. Добавление заказа на нашем сайте абсолютно бесплатное!';
