...
@section('content')
    ...
    <p class="text-center mt-3">Мы работаем с юридическими лицами и ИП. Оплата производится в безналичной форме, переводом денежных средств на наш расчётный счёт.</p>
