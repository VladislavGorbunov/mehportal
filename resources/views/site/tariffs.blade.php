...
@section('content')
    ...
    <p class="text-center mt-3">Мы работаем с юридическими лицами, физическими лицами и ИП. Оплатить тариф можно банковской картой на сайте или запросить счёт для оплаты.</p>
