...
@section('content')
    ...
    <div class="row mt-5">
        ...
        <p>Если у Вас есть какие либо вопросы или предложения, напишите нам в онлайн чат или на электронную почту, ответим в рабочее время с 9:00 до 21:00 по МСК</p>
