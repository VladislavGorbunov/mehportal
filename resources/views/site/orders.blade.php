...
@section('content')
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/"><small>Главная</small></a></li>
                    @if ($breadcrumb['region'])
                        <li class="breadcrumb-item"><a href="/{{ $breadcrumb['region_slug'] }}"><small>Каталог заказов {{ $breadcrumb['region'] }}</small></a></li>
                    @else 
                        <li class="breadcrumb-item"><small>Каталог заказов</small></li>
                    @endif
    ...
    <div class="mt-4 mb-4">
        <div class="d-md-flex align-items-center">
            ...
            <div class="d-flex flex-row justify-content-end">
                <div class="row gx-3">
                    <div class="col-12 col-md-auto text-center mb-2 mb-md-0 mt-2 mt-md-0">
    ...
    <div class="mb-3 mt-2 d-flex justify-content-center flex-wrap">
        @foreach ($category->servicesAll as $service)
            @if ($region_slug !== '')
                <div class="services-list me-2 mb-2 d-flex justify-content-center align-items-center"><i class="bi bi-folder-check"></i> <a href="/{{ $region_slug }}/orders/service/{{ $service->slug }}">{{ $service->title }}</a></div>
            @else
                <div class="services-list me-2 mb-2 d-flex justify-content-center align-items-center"><i class="bi bi-folder-check"></i> <a href="{{ $region_slug }}/orders/service/{{ $service->slug }}">{{ $service->title }}</a></div>
            @endif
        @endforeach
