    ...
    <div class="col-12 col-md-8 mx-auto registration-form-block">
        <form method="post">
            ...
            <div class="d-flex justify-content-center align-items-center mb-1 flex-column">
                <x-site.logo />
                <p class="m-0 p-0"><small>Регистрация поставщика</small></p>
            </div>
                ...
                <div class="col-12 mt-3">
                    ...
                    <input class="form-check-input" type="checkbox" id="flexCheckChecked" name="checked" checked>
                        <label class="form-check-label" for="flexCheckChecked">
                            <small>Нажимая кнопку «Стать поставщиком», вы подтверждаете согласие с условиями <a href="{{ Route('dogovor') }}" target="_blank">Договора-оферты</a> и <a href="{{ Route('privacy-policy') }}" target="_blank">Политикой обработки персональных данных</a>.</small>
                        </label>
                    </div>
                </div>
                <div class="mt-4 text-center ">
                    <button type="submit" class="btn btn-registration">Стать поставщиком</button>
                </div>
            </div>
        </form>
