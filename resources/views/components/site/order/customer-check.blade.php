<p class="mt-3 mb-0 fs-5"><b>Данные о заказчике из ФНС и ФАС:</b> </p>
...
@else
    <div class="alert alert-primary text-center mt-3">
        <small>Нам не удалось получить данные о заказчике по его ИНН.<br>
        Вы можете попробовать проверить компанию самостоятельно на этом ресурсе:<br>
        </small> 
